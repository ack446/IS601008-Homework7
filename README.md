...
the target website. You must make your program generate a QR code that takes someone to your GitHub homepage i.e. https://github.com/ack446
...
![QR CODE IMAGE](./qr_codes/QRCode_20240402164058.png)


2.  Add an image of viewing the log of successfully creating the QR code below.

![LOG IMAGE](./logs/01.png)
![LOG IMAGE](./logs/02.png)
